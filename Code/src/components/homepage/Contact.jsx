...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div ref={contactSection} className="mt-10 flex flex-col gap-20 md:grid md:grid-cols-6 md:px-10">
        <div className="col-span-4">
          <h3 ref={heading} className="max-w-lg 2xl:max-w-3xl text-heading-3 2xl:text-5xl font-semibold leading-tight translate-y-10 opacity-0">
            Wanna Talk? Let&apos;s make meaningful connection.
          </h3>
          <p ref={body} className="mt-4 max-w-md 2xl:max-w-2xl text-body-2 2xl:text-2xl text-accent-100 translate-y-10 opacity-0">
            I am currently looking for opportunities in corporate world as a final year student, have something please drop it below. Thank you😄
          </p>
          <form
            name="contact"
            action="/contact"
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2">
              ...
              <div className="relative z-0 sm:col-span-2">
                <textarea
                  ...
                  name="message"
                  rows="2"
                  className="peer block w-full appearance-none border-0 border-b border-accent-100 bg-transparent px-0 py-3 focus:outline-none focus:ring-0"
                  placeholder=" "
                ></textarea>
                <label
                  htmlFor="message"
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                href="mailto:ankityadav870401@gmail.com"
                className="group relative w-fit cursor-pointer"
                target="_blank"
                rel="noreferrer"
              >
                <span>ankityadav870401@gmail.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              <a
                href="https://github.com/Ankit1349"
              ...
              <a
                href="https://www.linkedin.com/in/ankit-yadav22/"
